...
public enum EnemyType {
    ...
    STONE_GOLEM("Каменный голем", 260f, 22f, 5.0f, 0xFF7D766A, 29, Family.ELEMENTAL),
    WATER_GOLEM("Водный голем", 320f, 25f, 5.0f, 0xFF4BA3D9, 29, Family.ELEMENTAL),
    FIRE_GOLEM("Огненный голем", 360f, 27f, 6.0f, 0xFFE9652C, 29, Family.ELEMENTAL),
